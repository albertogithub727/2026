...
public class Flywheel extends SubsystemBase {
    ...
    private static final double MOTOR1_MAX_POSITION = 17.5;
    ...
    public Flywheel() {
        ...
        configMotor(flywheelMotor, Constants.Flywheel.motorInvert, NeutralModeValue.Brake);
        configMotor(flywheelMotor2, Constants.Flywheel.motor2Invert, Constants.Flywheel.neutralMode);
        ...
        // Zero motor positions on startup
        flywheelMotor.setPosition(0);
        flywheelMotor2.setPosition(0);

        // Actively hold both motors at position 0 so neither side drifts
        setPosition1(0);
        setPosition2(0);
    }
    ...
    private void configMotor(TalonFX motor, InvertedValue invert, NeutralModeValue neutralMode) {
        ...
        /* Motion Magic Config */
        config.MotionMagic.MotionMagicCruiseVelocity = Constants.Flywheel.motionMagicCruiseVelocity;
        config.MotionMagic.MotionMagicAcceleration = Constants.Flywheel.motionMagicAcceleration;
