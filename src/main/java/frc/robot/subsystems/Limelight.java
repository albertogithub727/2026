...
public class Limelight extends SubsystemBase {
    ...
    public Optional<Measurement> getMeasurement(Pose2d currentRobotPose) {
        // Set robot orientation for MegaTag2 accuracy
        ...
        // Get both MegaTag1 and MegaTag2 pose estimates
        ...
        if (poseEstimate_MegaTag1 == null || poseEstimate_MegaTag2 == null
                || poseEstimate_MegaTag1.tagCount == 0 || poseEstimate_MegaTag2.tagCount == 0) {
            return Optional.empty();
        }

        // Hybrid approach: MegaTag2 for stable position, MegaTag1 for rotation (counteracts gyro drift)
    ...
    public void periodic() {
        SmartDashboard.putBoolean(name + "/Has Target", LimelightHelpers.getTV(name));
